<template>
    <div style="background-color: azure;">
        ...
        <div class="row">
            ...
            <div class="card" style="width: 300px;background-color: aliceblue;" v-on:click="electronic">
                <div class="card-body">
                    <h5 class="card-title">Electronics</h5>
                    <img src="https://thumbs.dreamstime.com/b/many-used-modern-electronic-gadgets-use-white-floor-reuse-recycle-concept-top-view-164230611.jpg"
                        class="card-img-top" alt="Merlin">
                </div>
            </div>
            <div class="card" style="width: 300px;background-color: aliceblue;" v-on:click="misc">
        ...
        <div class="row">
            <div class="card" style="width: 300px; background-color: aliceblue;" v-on:click="utility">
                <img class="card-img-top" src="" alt="" />
                <div class="card-body">
            ...
            <div class="card" style="width: 300px; background-color: aliceblue;" v-on:click="auto">
                <img class="card-img-top" src="" alt="" />
                <div class="card-body">
