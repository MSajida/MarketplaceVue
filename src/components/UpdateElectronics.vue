                        ...
                        <b-card id="cardLogin" style="background-color: aliceblue;">
                            <b-form v-if="show" id="formRegister">
                                ...
                                <b-form-group id="input-group-1" label="Model Name" label-for="modelName"
                                    style="color: gray">
                                    <b-form-input id="modelName" class="input" v-model="Electronics.modelName"
                                        placeholder="Model Name" type="text"></b-form-input>
                                </b-form-group>
                                <b-form-group id="input-group-1" label="Dimensions" label-for="dimensions"
                                    style="color: gray">
                                    <b-form-input id="dimensions" class="input" v-model="Electronics.dimensions"
                                        placeholder="Dimensions" type="text"></b-form-input>
                                </b-form-group>
                                ...
                                <b-form-group id="input-group-1" label="Product Description" label-for="description"
                                    style="color: gray">
                                    <b-form-input id="description" class="input" v-model="Electronics.description"
